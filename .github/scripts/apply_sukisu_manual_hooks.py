...
extern int ksu_handle_sys_reboot(int magic1, int magic2, unsigned int cmd,
    ...
    # Remove older/wrong prototype variants from previous script revisions.
    data = re.sub(
    ...
    # Remove older/wrong call variants.
    data = re.sub(
    ...
    # Correct functional sys_reboot hook for KSU_KERNEL_VER_CODE:
    # pass &arg because handler expects void __user **arg.
    replace_once(
        path,
